    ...
    <div className="app-shell">
      <header className="top-bar">
        ...
        <div className="user-menu-wrap" ref={menuRef}>
          ...
          >
            {user?.picture
              ? <img src={user.picture} alt={initials} style={{ width: '100%', height: '100%', borderRadius: '50%', objectFit: 'cover' }} />
              : initials
            }
          </button>
          ...
          {menuOpen && (
            <div className="user-menu">
              {user?.name && (
                <div className="user-menu-item" style={{ fontWeight: 600, cursor: 'default', color: 'var(--text-sub)', fontSize: '0.8rem' }}>
                  {user.name}
                </div>
              )}
